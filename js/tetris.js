class Game {
  ...
  static SQUARE_LENGTH = screen.width > 420 ? 20 : 10;
  static COLUMNS = 10;
  static ROWS = 20;
  ...
  static COLORS = ["#264653", "#2a9d8f", "#e9c46a", "#f4a261", "#e76f51"];
...
<li class="list-group-item"> <kbd>Up Arrow Key</kbd><br>Rotate</li>
<br>
<li class="list-group-item"> <kbd>Direction Keys</kbd><br>Move tetromino</li>
</ul>
<br>
`
    );
  ...
  async askUserConfirmResetGame() {
    ...
    const result = await Swal.fire({
      title: "Reload",
      text: "¿Do you want to re start the game?",
      icon: "question",
